...
const SingleRefFaDocsPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            .service("refFaDocs")
            .get(urlParams.singleRefFaDocsId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
    ...
    return (
        <div className="col-12 flex flex-column align-items-center">
            ...
            <label className="text-sm text-primary">Filename</label>
                    ...
                    <label className="text-sm text-primary">Bank Id</label>
                    <div className="ml-3"><p className="m-0 ml-3" >{_entity?.bankId}</p></div>
                    <label className="text-sm text-primary">Facilityid</label>
                    <div className="ml-3"><p className="m-0 ml-3" >{_entity?.facilityid}</p></div>
